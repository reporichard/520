(function(window){
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
           ...
           ctx.shadowBlur = 2 + Math.sin(Date.now() * 0.003 + this.y) * 4;
        	ctx.moveTo(p.x, p.y);
    ...
    'rgb(255,210,230)'
        ...
        this.alpha = alpha || random(0.15, 0.7);
        this.angle = angle || random(0, 360);
        this.scale = scale || random(0.002, 0.006);
        this.place = place;
        this.speed = speed;
    ...
    Bloom.prototype = {
        ...
        draw: function() {
            ...
            ctx.globalAlpha = s.alpha + Math.sin(Date.now() * 0.002 + s.point.x) * 0.05;
